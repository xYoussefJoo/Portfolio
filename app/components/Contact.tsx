      ...
      <div className="max-w-7xl mx-auto space-y-20 relative z-10">
        ...
        <ScrollReveal variant="fade-in-up" className="space-y-4 max-w-2xl">
          ...
          <h2 className="text-4xl md:text-6xl font-extrabold tracking-tight text-[var(--text-primary)] leading-tight">
            ...
            <span className="bg-gradient-to-r from-[#8A60F1] to-fuchsia-500 bg-clip-text text-transparent">{t.contact.titleGradient}</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <ScrollReveal variant="slide-in-left" className="lg:col-span-5 space-y-6 w-full">
            <div className="glass-card rounded-3xl p-8 space-y-8 hover:border-[#8A60F1]/40 transition-colors duration-500">
              <h4 className="text-xl font-bold text-[var(--text-primary)] tracking-wide">{t.contact.infoTitle}</h4>
            ...
            <div className="glass-card text-[var(--text-primary)] rounded-3xl p-8 flex gap-4 border-[#8A60F1]/25 hover:border-[#8A60F1]/50 transition-all duration-500">
              ...
              <div className="space-y-2">
                <h5 className="font-bold text-lg text-[var(--text-primary)]">{t.contact.quoteTitle}</h5>
            ...
            <div className="glass-card rounded-3xl p-8 md:p-10 hover:border-[#8A60F1]/40 transition-colors duration-500">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label htmlFor="name" className="text-xs font-bold uppercase tracking-widest text-[#8A60F1]">{t.contact.form.nameLabel}</label>
                    <input
                      type="text"
                      id="name"
                      name="name"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="email" className="text-xs font-bold uppercase tracking-widest text-[#8A60F1]">{t.contact.form.emailLabel}</label>
                    <input
                      type="email"
                      id="email"
                      name="email"
                ...
                <div className="space-y-2">
                  <label htmlFor="subject" className="text-xs font-bold uppercase tracking-widest text-[#8A60F1]">{t.contact.form.scopeLabel}</label>
                  <input
                    type="text"
                    id="subject"
                    name="subject"
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 rounded-xl bg-[var(--input-bg)] border border-[var(--input-border)] text-[var(--text-primary)] placeholder-[var(--text-muted)] focus:outline-none focus:bg-[#8A60F1]/5 focus:border-[#8A60F1] focus:shadow-[0_0_15px_rgba(138,96,241,0.15)] text-sm transition-all shadow-sm"
                    placeholder={t.contact.form.scopePlaceholder}
                  />
                </div>

                <div className="space-y-2">
                  <label htmlFor="message" className="text-xs font-bold uppercase tracking-widest text-[#8A60F1]">{t.contact.form.briefLabel}</label>
                  <textarea
                    id="message"
                    name="message"
                    required
            ...
            >
              ...
              <div className="space-y-2">
                <h4 className="text-2xl font-bold text-[var(--text-primary)]">
                  {t.contact.modal.sendTo} <span className="bg-gradient-to-r from-[#8A60F1] to-fuchsia-500 bg-clip-text text-transparent">Kero Amir</span>
                </h4>
                <p className="text-sm text-[var(--text-secondary)] font-light">
                  {t.contact.modal.chooseMethod} <span className="font-semibold text-[#8A60F1]">{contactEmail}</span>:
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                >
                  ...
                  <div className="text-left flex-grow">
                    <span className="font-bold text-sm block">{t.contact.modal.gmail}</span>
                    <span className="text-[10px] opacity-80 block font-light">{t.contact.modal.gmailDesc}</span>
                  </div>
                ...
                >
                  ...
                  <div className="text-left flex-grow">
                    <span className="font-bold text-sm block">{t.contact.modal.defaultMail}</span>
                    <span className="text-[10px] text-[var(--text-muted)] block font-light">{t.contact.modal.defaultMailDesc}</span>
                  </div>
                  <ExternalLink className="w-4 h-4 opacity-60 group-hover:opacity-100 transition-opacity" />
                </a>
                ...
                >
                  ...
                  <div className="text-left flex-grow">
                    <span className="font-bold text-sm block">{copied ? t.contact.modal.copied : t.contact.modal.copy}</span>
                    <span className="text-[10px] text-[var(--text-muted)] block font-light">{t.contact.modal.copyDesc}</span>
                  </div>
                </button>
              </div>
            </motion.div>
