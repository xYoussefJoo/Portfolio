...
('Vortex Sound - Spatial Audio Identity', 'Vortex Sound - Spatial Audio Brand', 'Complete visual branding, custom typographic logotype, and advertising poster series for European audiophile brand.', 'Komplettes visuelles Branding, individuelles typografisches Logo und Werbeplakat-Serie für europäische Audiomarke.', 'advertising', 'https://images.unsplash.com/photo-1550684848-fac1c5b4e853?auto=format&fit=crop&w=800&q=60', ARRAY['After Effects', 'Photoshop'], 'United States', 'USA', '🇺🇸', '2023', '#8A60F1', ARRAY['Adobe After Effects', 'Adobe Photoshop', 'Illustrator'], ARRAY['Animated Billboard Promos', 'Kinetic Posters'], ARRAY['Animierte Billboard-Promos', 'Kinetische Plakate'], 3),
('NeoHaus - Architectural Studio Book', 'NeoHaus - Architektur-Buchband', 'Editorial layout, grid architecture, typography, and premium print-ready book in Adobe InDesign for Berlin studio.', 'Redaktionelles Layout, typografisches Rastersystem und hochwertiges, druckfertiges Buch in Adobe InDesign für Berliner Studio.', 'editorial', 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&fit=crop&w=800&q=60', ARRAY['Adobe InDesign', 'Photoshop'], 'Egypt & Germany', 'Ägypten & Deutschland', '🇪🇬 🇩🇪', '2023', '#F43F5E', ARRAY['Adobe InDesign', 'Adobe Photoshop', 'Lightroom'], ARRAY['180-Page Art Book Layout', 'Embossed Hardcover'], ARRAY['180-Seiten Artbook-Layout', 'Geprägtes Hardcover'], 4),
