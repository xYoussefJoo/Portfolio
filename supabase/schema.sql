...
CREATE INDEX IF NOT EXISTS idx_sections_key ON public.sections (key);
CREATE INDEX IF NOT EXISTS idx_social_links_created ON public.social_links (created_at ASC);
...
('Marcus Vance', 'Creative Director', 'Vance Studio NYC', 'United States', 5, 'Kero transformed our complete brand identity with unbelievable precision and creativity. The 3D assets and visual language took our agency launch to the next level.', 'approved', 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=128&q=60'),
('Sophie Dubois', 'Brand Marketing Head', 'Lumière Paris', 'France', 5, 'Exceptional artistic sensitivity. Kero delivered complex visual campaigns in English and French ahead of deadline with impeccable attention to detail.', 'approved', 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=128&q=60'),
('Alexander Meyer', 'Founder & CEO', 'Klang Audio Berlin', 'Germany', 5, 'Working with Kero was an absolute pleasure. His mastery of typography, 3D composition, and modern aesthetics is world-class.', 'approved', 'https://images.unsplash.com/photo-1570295999919-56ceb5ecca61?auto=format&fit=crop&w=128&q=60'),
('Elena Rostova', 'VP of Design', 'Aura Labs Zurich', 'Switzerland', 5, 'The speed, precision, and sheer creativity Kero brings to the table is unmatched. Highly recommended for any serious design project.', 'approved', 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=128&q=60')
ON CONFLICT DO NOTHING;
